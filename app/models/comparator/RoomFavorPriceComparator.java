 ...
 * @FileName: RoomFavorPriceComparator.java
 * @author: tonywang
 ...
 * @author CJWang
 */
public class RoomFavorPriceComparator implements Comparator<RoomInfo> {
  ...
  public int compare(RoomInfo room1, RoomInfo room2) {
    ...
    return room1.getFavorPrice().compareTo(room2.getFavorPrice());
  }
